...
function Wordmark({
  ...
  return /*#__PURE__*/React.createElement("button", {
    ...
    style: {
      ...
      height: 30,
      borderRadius: 9,
      background: light ? "#fff" : "var(--lilac-500)",
